...
const char *PROGRESS_TEXT[] = {"Updating times...", "Updating OWM...", "Updating astronomy...", "Updating OpenMeteo...", "Done..."};
...
const char *HTML_TEXT[] = {"ESP8266 Weather Station ", "Device Settings", "Security Settings", "OpenWeatherMap API Key", "Enter your API key", "Show", "OpenCage API Key", "City Name", "Example: Istanbul", "Country Name", "Example: Turkey", "Find Location/Timezone from City", "Latitude", "Example: 41.17", "Longitude", "Example: 28.86", "Time Zone", "Select Unit", "Metric", "Imperial", "Update Interval (Minutes)", "Save", "Homepage", "Please enter city, country and OpenCage API key.", "Location not found.", "API request failed.", "About", "Password", "Username", "Enter username", "Enter password", "Default Settings", "Restore to default settings. The device is restarting...", "Restore to Default Settings", "The device will be reset to default settings. Continue?", "Hide", "OTA Update", "Turn On Time", "Turn Off Time", "Security information successfully changed.", "Device settings saved successfully. Redirecting to homepage...", "get from", "here", "Flip display orientation", "Saving...", "Display Settings", "Display settings saved successfully. Redirecting to homepage...", "API Key Settings", "API keys saved successfully. Redirecting to homepage...", "Time zone not found", "Time zones could not be retrieved: ", "Time zones could not be loaded.", "Display Contrast", "Time Format", "Update Data", "24-hour", "12-hour", "Month Display Format", "As Number", "As Name", "Please enter the on/off time in 24-hour format.", "Show on Map", "World Clock Settings", "World clock settings saved successfully. Redirecting to homepage...", "Security settings saved successfully. Redirecting to homepage..."};

const char *LOG_TEXT[] = {"WEATHER STATION", "Signal Strength (RSSI): ", "Use this URL : ", "Setting readyForUpdate to true", "Display was turned on: ", "Display was turned off: ", "Time to turn display on: ", "Time to turn display off: ", "deserializeJson() failed: ", "Entered config mode", "Please connect to AP", "To setup WiFi connection", "Device Settings Updated:", "Security Settings Updated:", "There is no file with that name.", "OTA update started!", "OTA Progress", "Current", "Final", "OTA update finished successfully!", "There was an error during OTA update!", "API Keys Updated:", "Waiting for NTP time...", "Time synchronized.", "Display Settings Updated:", "World Clock Settings Updated:", "File open failed!","Saving settings now..."};
